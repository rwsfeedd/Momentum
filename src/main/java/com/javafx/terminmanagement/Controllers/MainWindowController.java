...
public class MainWindowController {
    ...
    public void initialize() {
        ...
        taskCreateButton.setVisible(false);
        taskChangeButton.setVisible(false);
        taskDeleteButton.setVisible(false);
        signInButton.setVisible(false);
        signOutButton.setVisible(false);
        taskDoneButton.setVisible(false);
        taskSaveButton.setVisible(false);

        //Eventhandlerinitialisierung möglicherweise auslagerbar
        dailyTab.setOnSelectionChanged(new EventHandler<Event>() {
            @Override
            public void handle(Event event) {
                if (dailyTab.isSelected()) {
                    signOutButton.setVisible(true);
                    taskDoneButton.setVisible(true);
                    taskCreateButton.setVisible(false);
                    taskChangeButton.setVisible(false);
                    taskDeleteButton.setVisible(false);
                    signInButton.setVisible(false);
        ...
        allTasksTab.setOnSelectionChanged(new EventHandler<Event>() {
            @Override
            public void handle(Event event) {
                if (allTasksTab.isSelected()) {
                    taskCreateButton.setVisible(true);
                    taskChangeButton.setVisible(true);
        ...
        createTaskTab.setOnSelectionChanged(new EventHandler<Event>() {
            ...
            public void handle(Event event) {
                if (createTaskTab.isSelected()) {
                    ...
                    signOutButton.setVisible(false);
                    taskDoneButton.setVisible(false);
                    taskSaveButton.setVisible(true);
                }
            }
        });

        /*
        createTaskTab.setOnClosed(new EventHandler<Event>() {
            @Override
            public void handle(Event event) {
                model.createTabClosedProperty().set(true);
            }
        });
         */
